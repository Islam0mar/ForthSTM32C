...
const uint8_t F_IMMED = 0x80;
const uint8_t F_COMPO = 0x40;
const uint8_t F_HIDDEN = 0x20;
const uint8_t F_FLASH = 0x10;
...
extern uint32_t PS[512];
extern uint32_t RS[256];
extern FuncPtr *IP;
extern FuncPtr W;
# 9 "words.h" 2
...
_Bool 
# 52 "dictionary.h"
    addDictionaryEntry(char *name, uint8_t flags, uint8_t length,
                        FuncPtr ptr[], Dictionary *pd);
# 5 "macros.h" 2
# 11 "words.h" 2
# 41 "words.h"
void quit() { longjmp(env, 0); } const DictionaryEntry quit_entry = {.flags = (uint8_t)0, .length = 1, .ptr = (void*)&quit}; const DictionaryNode quit_node = {.next = 
# 41 "words.h" 3 4
((void *)0)
# 41 "words.h"
, .entry = quit_entry}
...
void interpret() { } const DictionaryEntry interpret_entry = {.flags = (uint8_t)0, .length = 1, .ptr = (void*)&interpret}; const DictionaryNode interpret_node = {.next = 
# 48 "words.h" 3 4
((void *)0)
# 48 "words.h"
, .entry = interpret_entry}
